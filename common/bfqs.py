  ...
  "Batfish": [
    {
      ...
      "description": "This set of questions allows you to learn how well Batfish understands your network snapshot.",
      "questions": [
        {
          "fun": "initIssues",
    ...
    },
    {
      ...
      "description": "This set of questions  enables you to retrieve and process the contents of device configurations in a vendor-agnostic manner (except where the question itself is vendor-specific). Batfish organizes configuration content into several sub-categories.",
      "questions": [
        {
          "fun": "nodeProperties",
          "input": [
    ...
    {
      "category": "Topology",
      "description": "This set of questions  is intended to retrieve the network topology used by Batfish. This topology is a combination of information in the snapshot and inference logic (e.g., which interfaces are layer3 neighbors). Currently, Layer 3 topology can be retrieved.",
      "questions": [
        {
    ...
    },
    {
      ...
      "description": "This set of questions  reveals information regarding which routing protocol sessions are compatibly configured and which ones are established. It also allows to you analyze BGP routing policies.",
      "questions": [
        {
    ...
    },
    {
      ...
      "description": "This set of questions  allows you to query the RIBs and FIBs computed by Batfish.",
      "questions": [
        {
          "fun": "routes",
          "input": [
    ...
    },
    {
      ...
      "description": "This set of questions  allows you to query how different types of traffic is forwarded by the network and if endpoints are able to communicate. You can analyze these aspects in a few different ways.",
      "questions": [
        {
          "fun": "traceroute",
          "input": [
    ...
    },
    {
      ...
      "description": "This set of questions  allows you to analyze the behavior of access control lists and firewall rules. It also allows you to comprehensively validate (aka verification) that some traffic is or is not allowed.",
      "questions": [
        {
    ...
    },
    {
      ...
      "description": "This set of questions  allows you to query IPSec sessions and tunnels.",
      "questions": [
        {
    ...
    },
    {
      ...
      "description": "This set of questions  allows you to query aspects of VXLAN and EVPN configuration and behavior.",
      "questions": [
        {
    ...
    },
    {
      ...
      "description": "Specifier grammars allow you to specify complex inputs for Batfish questions. This set of questions  reveals how specifier inputs are resolved by Batfish.",
      "questions": [
        {
    ...
    },
    {
      ...
      "description": "Differential questions enable you to discover configuration and behavior differences between two snapshot of the network. Most of the Batfish questions can be run differentially, but Batfish also has two questions that are exclusively differential.",
      "questions": [
        {
          "fun": "compareFilters",
          "input": [
